 ...
 * Clicking triggers the onPress callback to open the artifact panel.
 */
...
interface DocumentPreviewProps {
  ...
  onPress?: (doc: { id: string; title: string; kind: ArtifactKind; content?: string; language?: string }) => void;
}
...
export const DocumentPreview = memo(function DocumentPreview({
  ...
  const handlePress = () => {
    onPress?.({ id, title, kind, content, language });
  };
