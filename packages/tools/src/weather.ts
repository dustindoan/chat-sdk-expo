 ...
 * Supports both coordinates and city name input.
 */
 ...
 */
export function createWeatherTool(options: WeatherToolOptions = {}) {
...
/**
 * Default weather tool with approval required
 * For backwards compatibility
 */
export const weatherTool = createWeatherTool({ needsApproval: true });
