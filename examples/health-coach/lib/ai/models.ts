...
/**
 * Model shorthand map for workflow/agent configurations
 * Maps simple names to full model IDs
 */
...
/**
 * Type for model shorthand identifiers
 */
export type ModelShorthand = keyof typeof MODEL_SHORTHAND_MAP;
